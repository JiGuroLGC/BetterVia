...
**Via** Browser is a lightweight Android application developed by Shanghai Zhiwei Network Technology Co., Ltd., renowned for its speed, simplicity, and security.  

### Simple and Pure
Geek-friendly minimalist design, free from push notifications and distractions  
### Lightning-Fast Search
Millisecond launch times, rapid webpage loading
### Effortless Browsing
Compact footprint, low memory usage, no lag
### Security & Privacy
Sandboxed architecture, minimal permissions, robust privacy protection
### Customisation & Extensibility
Resource detection, practical plugins, tailored to individual needs  

However, **Via** still has some shortcomings, such as incomplete features and occasionally inconvenient user operations. Following Android 4.4.1, **Via** introduced a built-in whitelist. Websites listed here will have restrictions on resource sniffing, ad blocking, and browser script usage. These issues are precisely why this module exists.

#### Resource Sniffer Whitelist
